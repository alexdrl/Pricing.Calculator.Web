...
namespace Pricing.Calculator.Web.App.ApiClients.CalculatorClient.Models
{
    ...
    /// </summary>
    public partial class ForwardCalculationDto
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ForwardCalculationDto class.
        /// </summary>
        public ForwardCalculationDto()
        {
            CustomInit();
        }
        ...
        /// code.</param>
        public ForwardCalculationDto(IList<ItemDto> items, string orderId = default(string), string currencyIso = default(string), string sourceCountryIso = default(string), string declarationCountryIso = default(string), string brandCode = default(string))
        {
            OrderId = orderId;
